...
def vit_base_patch16(args):
    ...
    vit_cfg.image_size = args['image_size']
    vit_cfg.num_classes = args['n_cls']
...
def vit_base_patch32(args):
    ...
    vit_cfg.depth = 12
    vit_cfg.heads = 12
    vit_cfg.mlp_dim = 3072 # 隐藏层的维度，一般是4*d_model
    vit_cfg.dim_head = vit_cfg.d_model // vit_cfg.heads
...
def get_network(backbone_name, args):
    ...
    elif backbone_name == 'vit_small_patch16':
        backbone = vit_small_patch16(args=args)
    else:
